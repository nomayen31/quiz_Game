...
const Questions = ({questions}) => {
    ...
    return (
        <div className='text-center flex flex-col justify-center items-center shadow-lg p-10 pb-10 rounded-3xl bg-slate-200 mb-12'>
            ...
            <button type="button" onClick={watchAns} className="  px-8 py-3 md:ml-96 lg:ml-[40rem] bg-slate-500 font-semibold rounded-full "><AiFillEye size={25} className="h-6 w-6 text-white"/></button>
