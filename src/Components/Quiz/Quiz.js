    ...
    return (
        <div className=' p-5 shadow-xl  rounded-xl'>
            ...
            <div className="flex justify-between p-2 mt-6 ">
                <h2 className='text-blue-600 mt-2 font-bold'>{name}</h2>
                <button onClick={handelClick} className='px-3 py-2 bg-blue-800 rounded-full text-sm text-white'>Start Quiz</button>
            </div>
